...
--
-- Host: localhost
-- Generation Time: Jul 26, 2013 at 05:40 PM
...
(1, 1, 'Justin', 'Scott', 'justins@motherlodemakers.com', '', '', ''),
...
(3, 'Community Member', 'Participating Community Member.', 10, 12, 30),
...
(1, 'admin', 'b9eda5e15ea098b9faecd8aca92b59b1d4153186001d577e8218331cd15868ab911003a09e8896ec45cd5112cb89d42087ca39d2c32c56a1e24ca7ef410a1beb', 'ce40199183c9b50d07e86a7004d3bcde0e5a0f0bdcc5eb88903d7a27c8e7b456', '', 1374815246, 1374885384, 1374885598, 1374816786, 0, 1, 1, NULL, 'Instant'),
(2, 'demo', '18fb1b916c024e73b18cedbe1b944dc0fd5d2e5711476fec85c77fc1577bc190732e719b23dbbd601010fba05f8b3cef130e14c415ae2bb6acd45948d396c0fd', '539dd0923a9c36a3abd738388a81962cb89510b08b6b6b6edac6cafc6e6b81ca', '', 1374815246, 0, 0, 0, 0, 0, 1, NULL, 'Instant');
...
CREATE TABLE IF NOT EXISTS `userProfile` (
  `uuid` mediumint(4) unsigned NOT NULL AUTO_INCREMENT COMMENT 'unique user id',
  `firstName` varchar(30) NOT NULL,
  `lastName` varchar(50) NOT NULL,
  `userName` varchar(20) NOT NULL,
  `pwSupperHash` varchar(68) NOT NULL,
  `emailAddress` varchar(20) NOT NULL,
  `mailStreet` varchar(40) NOT NULL,
  `mailCity` varchar(20) NOT NULL,
  `mailState` tinytext NOT NULL,
  `mailZip` tinyint(5) NOT NULL,
  `certList` longblob NOT NULL,
  `accountStatus` tinyint(1) NOT NULL,
  `situationTicketID` smallint(8) NOT NULL,
  `mlmBillingPlan` tinyint(3) NOT NULL,
  `makerRank` tinyint(2) NOT NULL,
  `makerClass` tinyblob NOT NULL,
  `suMakerClass` blob NOT NULL,
  `timeInRank` datetime NOT NULL,
  `websiteSignup` datetime NOT NULL,
  `communitySignup` datetime NOT NULL,
  PRIMARY KEY (`uuid`)
